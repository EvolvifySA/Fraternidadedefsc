        ...
        <div className="contato">
          ...
          <div className="icons">
            ...
            target="_blank" rel="noreferrer">
              <img src="/src/assets/icon/facebook_icone.png" alt="Facebook" />
            </a>
            <a href="https://www.instagram.com/fraternidadefsc/" 
            target="_blank" rel="noreferrer">
              <img src="/src/assets/icon/instagram_icone.png" alt="Instagram" />
            </a>
            <a href="https://api.whatsapp.com/send/?phone=5583991853511&text&type=phone_number&app_absent=0&wame_ctl=1&source_surface=23" 
            target="_blank" rel="noreferrer">
              <img src="/src/assets/icon/whatsapp_icone.png" alt="WhatsApp" />
            </a>
            <a href="https://www.youtube.com/@fraternidadefsc" 
            target="_blank" rel="noreferrer">
              <img src="/src/assets/icon/youtube_4494485.png" alt="Youtube" />
            </a>
          </div>
        </div>
